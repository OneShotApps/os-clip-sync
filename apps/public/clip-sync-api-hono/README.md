...
This self-contained Bun/Hono application provides passwordless and Google OIDC authentication, owner-scoped device naming and history, item persistence, and online-only WebSocket delivery.
