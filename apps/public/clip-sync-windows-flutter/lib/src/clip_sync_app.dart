...
/// Windows presentation shell. Domain and transport behavior remain in client core.
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 8),
                Text(
                  controller.isPaused ? 'New copies stay only on this PC.' : 'New text and photos are sent to your private clipboard.',
                ),
                const Spacer(),
                Text(
                              ...
                              try {
                                ...
                                if (context.mounted) {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    const SnackBar(
                                      content: Text('Copied to this PC.'),
                                    ),
                                  );
                                }
                              } catch (_) {
